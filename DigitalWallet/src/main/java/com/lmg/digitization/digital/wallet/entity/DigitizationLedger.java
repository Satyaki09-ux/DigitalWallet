...
@Entity
@DynamicUpdate
@Table(name = "LMG_DIGITIZATION_LEDGER")
public class DigitizationLedger {
	...
	@Column(name = "LEDGER_ID", columnDefinition = "NUMERIC(25,0)")
	private BigInteger ledgerId;

	@Column(name = "WLT_ID", columnDefinition = "VARCHAR(25)")
	...
	@Column(name = "DC_DY_BSN", columnDefinition = "DATETIME NOT NULL")
