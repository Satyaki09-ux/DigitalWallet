...
public class RevertCashbackRedeemOnInvoiceResponse {

	public RevertCashbackRedeemOnInvoiceResponse(String walletId, BigDecimal balance, String currency, String shukranId, String status) {
		super();
	...
	public RevertCashbackRedeemOnInvoiceResponse() {
		super();
	}
